...
class SplitsAdapter:
    ...
    def fetch(self, symbol: str) -> dict:
        ...
        sym = symbol.upper()
        url = f"https://api.polygon.io/v3/reference/splits?ticker={sym}&limit=20&apiKey={key}"
        try:
...
register("corporate.splits", SplitsAdapter)
